1. check the permissions of a file in Linux, using ls -l filename:
For example, running ls -l might yield an output like:
-rw-r--r-- 1 user group 4468 Nov 19 2009 myfile.txt

2. chmod [who][operation][permission] file
command:
chmod a+rx /tmp/xfusioncorp.sh
or
chmod 755  /tmp/xfusioncorp.sh

3. check by executing the file: bash filename
